...
/* harmony import */ var _inscription_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./inscription-routing.module */ "PcKT");
/* harmony import */ var _inscription_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./inscription.page */ "XJuG");
...
/* harmony import */ var _inscription_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inscription.page */ "XJuG");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_inscription_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./inscription.page.html */ "E28F");
/* harmony import */ var _inscription_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./inscription.page.scss */ "/1rV");
...
let InscriptionPage = class InscriptionPage {
    constructor(formBuilder, service, toastController, router) {
    ...
    register() {
        ...
        if (this.userForm.value.password === this.userForm.value.passwordCheck) {
            ...
            if (this.passwordStrenghtTest(this.userForm.value.password)) {
                ...
                let elements = document.querySelectorAll("ion-input , ion-button , ion-select");
                this.service.register(this.user).subscribe((res) => {
                    ...
                    _utils_ToastUtils__WEBPACK_IMPORTED_MODULE_9__["ToastUtils"].presentToast("Utilisateur créé!", "success", this.toastController);
                    this.router.navigate(["home"]);
                }, (error) => {
                    if (error.status === 412) {
                        ...
                        _utils_ToastUtils__WEBPACK_IMPORTED_MODULE_9__["ToastUtils"].presentToast("Cet e-mail est déjà utilisé", "danger", this.toastController);
                        let mail = document.querySelector("ion-input[formControlName='email']");
                ...
                if (_utils_EmailUtils__WEBPACK_IMPORTED_MODULE_8__["EmailUtils"].verifyEmail(value.email)) {
                }
                else {
                ...
                _utils_ToastUtils__WEBPACK_IMPORTED_MODULE_9__["ToastUtils"].presentToast("Votre mot de passe n'est pas assez robuste", "danger", this.toastController);
                this.passwordRule = true;
            }
        }
        else {
            _utils_ToastUtils__WEBPACK_IMPORTED_MODULE_9__["ToastUtils"].presentToast("Les deux mots de passe ne sont pas identiques", "danger", this.toastController);
        }
    }
    registerKey(event) {
