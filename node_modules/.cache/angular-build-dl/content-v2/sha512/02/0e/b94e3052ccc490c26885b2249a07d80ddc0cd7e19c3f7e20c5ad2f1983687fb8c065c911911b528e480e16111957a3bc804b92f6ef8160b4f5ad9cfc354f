(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~menu-semaine-menu-semaine-module~modal-modal-module"], {
    ...
    function AfR(module, __webpack_exports__, __webpack_require__) {
      ...
      var _cantiniere_api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var ModalPage = /*#__PURE__*/function () {
        ...
        // @Input()src:string
        // image:string
        function ModalPage(modalCtrl, apiService) {
...
//# sourceMappingURL=default~menu-semaine-menu-semaine-module~modal-modal-module-es5.js.map